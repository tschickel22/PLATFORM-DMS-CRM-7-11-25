...
export function PDFBuilderLite({ 
  url, 
  fields, 
  mergeFields, 
  onFieldsChange, 
    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 overflow-auto p-8 bg-gray-100" ref={containerRef}>
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Simplified PDF Display - Single Page */}
          <div
            className="relative bg-white shadow-lg inline-block w-full min-h-[800px]"
          ...
          >
            ...
            <div className="w-full h-full border-2 border-dashed border-gray-300 flex items-center justify-center">
              <div className="text-center text-gray-500">
                ...
                <div className="text-sm">Drag fields here to position them</div>
                {url && (
