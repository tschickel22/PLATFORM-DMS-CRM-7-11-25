/*
  ...
  2. Security
    - RLS is DISABLED for all tables for development
    - No policies are created
    - Full access allowed during development phase
...
CREATE TABLE IF NOT EXISTS deals (
  ...
  amount numeric DEFAULT 0,
  source text,
  type text DEFAULT 'New Sale'::text,
...
DROP TRIGGER IF EXISTS update_win_loss_reports_updated_at ON win_loss_reports;
